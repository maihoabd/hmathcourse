...
<p class="text-xs text-slate-500 leading-relaxed">Luyện đề tổng hợp số 2 môn Hình học phẳng nâng cao, ôn tập chuẩn chỉnh toàn bộ chương trình cả năm.</p>` }
  ...
  const ch2_1 = await prisma.chapter.create({ data: { courseId: 'c2', title: 'Chương 1: Đa thức và Các phép toán đa thức (9 bài giảng)' } });
  ...
  const c2Lessons = [
    ...
    // Ch 1
    { id: 'c2-l1', chapterId: ch2_1.id, title: '01. Đơn thức và đa thức nhiều biến. Thu gọn đa thức', duration: '45 phút', isPreview: false, videoUrl: 'https://www.youtube.com/embed/U4wDg_tYyek', documentUrl: 'https://drive.google.com/open?id=14Uh7CJ8x6cbAzmwGBc4RRlZZ5PRi2Pw4', textContent: 'Học sinh làm quen với các khái niệm đơn thức, đa thức nhiều biến. Phương pháp và các bước thu gọn đa thức nhiều biến tối giản.' },
    { id: 'c2-l2', chapterId: ch2_1.id, title: '02. Phép cộng và phép trừ đa thức nhiều biến', duration: '40 phút', isPreview: false, videoUrl: 'https://www.youtube.com/embed/4lJSXxrgk3c' },
    { id: 'c2-l3', chapterId: ch2_1.id, title: '03. Phép nhân đơn thức với đa thức & nhân đa thức', duration: '45 phút', isPreview: false, videoUrl: 'https://www.youtube.com/embed/4lJSXxrgk3c' },
    { id: 'c2-l4', chapterId: ch2_1.id, title: '04. Phép chia đa thức cho đơn thức và tính chất chia hết', duration: '40 phút', isPreview: false, videoUrl: 'https://www.youtube.com/embed/4lJSXxrgk3c' },
    { id: 'c2-l5', chapterId: ch2_1.id, title: '05. Luyện tập tổng hợp đơn thức và đa thức nhiều biến', duration: '50 phút', isPreview: false, videoUrl: 'https://www.youtube.com/embed/4lJSXxrgk3c' },
    { id: 'c2-l6', chapterId: ch2_1.id, title: '06. Phân tích đa thức thành nhân tử (Bằng đặt nhân tử chung)', duration: '45 phút', isPreview: false, videoUrl: 'https://www.youtube.com/embed/4lJSXxrgk3c' },
    { id: 'c2-l7', chapterId: ch2_1.id, title: '07. Phân tích đa thức bằng phương pháp dùng hằng đẳng thức', duration: '45 phút', isPreview: false, videoUrl: 'https://www.youtube.com/embed/4lJSXxrgk3c' },
    { id: 'c2-l8', chapterId: ch2_1.id, title: '08. Phân tích đa thức bằng phương pháp nhóm hạng tử', duration: '40 phút', isPreview: false, videoUrl: 'https://www.youtube.com/embed/4lJSXxrgk3c' },
    { id: 'c2-l9', chapterId: ch2_1.id, title: '09. Phân tích đa thức phối hợp nhiều phương pháp nâng cao', duration: '55 phút', isPreview: false, videoUrl: 'https://www.youtube.com/embed/4lJSXxrgk3c' },
