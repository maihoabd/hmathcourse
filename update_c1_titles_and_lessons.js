...
<h4 class="font-bold text-slate-800 text-sm mb-2">Tóm tắt nội dung học:</h4>
<p class="text-xs text-slate-500 leading-relaxed">Khảo sát quan hệ giữa ba cạnh của một tam giác, định lý bất đẳng thức tam giác và điều kiện tồn tại tam giác.</p>`
  },
  {
    id: 'c1-l25',
...
async function run() {
  try {
    console.log('Updating course titles...');
    ...
    console.log('Updating final lessons in DB...');
    ...
    console.log('SUCCESS! Course titles and final lessons updated in DB.');
  } catch (err) {
